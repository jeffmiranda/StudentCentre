<?php
require_once (dirname(__FILE__).'/scclassupdate.class.php');
class scClassUpdateFromGridProcessor extends scClassUpdateProcessor {
...
return 'scClassUpdateFromGridProcessor';
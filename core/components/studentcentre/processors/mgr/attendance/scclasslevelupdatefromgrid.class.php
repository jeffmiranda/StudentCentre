<?php
require_once (dirname(__FILE__).'/scclasslevelupdate.class.php');
class scClassLevelUpdateFromGridProcessor extends scClassLevelUpdateProcessor {
...
return 'scClassLevelUpdateFromGridProcessor';
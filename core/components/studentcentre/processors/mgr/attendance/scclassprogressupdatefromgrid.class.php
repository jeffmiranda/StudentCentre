<?php
require_once (dirname(__FILE__).'/scclassprogressupdate.class.php');
class scClassProgressUpdateFromGridProcessor extends scClassProgressUpdateProcessor {
...
return 'scClassProgressUpdateFromGridProcessor';
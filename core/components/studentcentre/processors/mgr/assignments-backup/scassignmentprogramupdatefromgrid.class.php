<?php
require_once (dirname(__FILE__).'/scassignmentprogramupdate.class.php');
class scAssignmentProgramUpdateFromGridProcessor extends scAssignmentProgramUpdateProcessor {
...
return 'scAssignmentProgramUpdateFromGridProcessor';